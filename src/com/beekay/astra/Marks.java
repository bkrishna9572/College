...
public class Marks extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MarksSession ms=new MarksSession();
		ms.execute("http://borealis.astra.edu.in/index.php?option=com_base_sessionalresultreport&task=stuinfo&Itemid=243");
	...
	public class MarksSession extends AsyncTask<String, String, String>{
		...
		protected String doInBackground(String... params) {
			...
			MarksSession m=new MarksSession();
			String page=m.getPageContent(url);
			System.out.println(page);
			String text=m.getText(page);
			return text;
		}
		...
		protected void onPostExecute(String result) {
			// TODO Auto-generated method stub
			ProgressBar prog=(ProgressBar)findViewById(R.id.mprog);
